...
public class Veiculo implements Comparable<Veiculo>, Serializable {
    ...
    public Veiculo(String marca, String modelo, String matricula, int ano, double velociademedia, double precokm, ArrayList<Integer> classificacao,
    ...
    public String toString(){
        ...
        s.append("Carro: ").append(this.marca).append(" ").append(this.modelo).append(" ").append(this.matricula);
